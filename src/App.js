...
function App() {
  ...
  const {timerWarmUpSec, timerCoolDownSec, spotifyURILow, exercises, timeSeekPosMs, timerRestSec, spotifyURIHigh, timerLowSec, timerHighSec, youtubeURL} = importParser()
